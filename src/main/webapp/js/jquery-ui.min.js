...
* http://jqueryui.com
* Includes: core.js,
 * widget.js, mouse.js, position.js, accordion.js, autocomplete.js, button.js,
 * datepicker.js, dialog.js, draggable.js, droppable.js, effect.js,
 ...
 * resizable.js, selectable.js, selectmenu.js, slider.js, sortable.js,
...
(function (e) {
    ...
    function n() {
        ...
        this.dpDiv = a(e(
            "<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-con" +
            "tent ui-helper-clearfix ui-corner-all'></div>"
        ))
    }
    function a(t) {
        ...
        return t
            .delegate(i, "mouseout", function () {
                ...
                -1 !== this
                    .className
                    .indexOf("ui-datepicker-prev") && e(this).removeClass(
                        "ui-datepicker-prev-hover"
                    ),
                -1 !== this
                    .className
                    .indexOf("ui-datepicker-next") && e(this).removeClass(
    ...
    e
        ...
        .extend({
            ...
            disableSelection: function () {
                var e = "onselectstart" in document.createElement("div")
                    ? "selectstart"
                    : "mousedown";
                return function () {
                ...
                ? this.each(function () {
                    ...
                    return "instance" === n
                        ...
                        : a
                            ...
                            : e.error(
                                "cannot call methods on " + t + " prior to initialization; attempted to call me" +
                                "thod '" + n + "'"
                            )
                })
                : this.each(function () {
    ...
    e.Widget.prototype = {
        ...
        _createWidget: function (t, i) {
            ...
            this.options = e
                .widget
                .extend({}, this.options, this._getCreateOptions(), t),
            this._create(),
        ...
        _setOption: function (e, t) {
            ...
            "disabled" === e && (this.widget().toggleClass(
    ...
    e.widget("ui.mouse", {
        ...
        _mouseDown: function (t) {
            if (!d) {
                ...
                var i = this,
                    s = 1 === t.which,
                    n = "string" == typeof this.options.cancel && t.target.nodeName
                        ? e(t.target)
        ...
        e.position = {
            scrollbarWidth: function () {
                ...
                var t,
                    i,
                    s = e(
                        "<div style='display:block;position:absolute;width:50px;height:50px;overflow:hi" +
                        "dden;'><div style='height:100px;width:auto;'></div></div>"
                    ),
                    a = s.children()[0];
            ...
            getScrollInfo: function (t) {
                var i = t.isWindow || t.isDocument
                        ? ""
                        : t
                            .element
                            .css("overflow-x"),
                    s = t.isWindow || t.isDocument
                        ? ""
                        : t
                            .element
                            .css("overflow-y"),
                    n = "scroll" === i || "auto" === i && t.width < t
                        .element[0]
                        .scrollWidth,
                    a = "scroll" === s || "auto" === s && t.height < t
                        .element[0]
                        .scrollHeight;
                return {
                    width: a
        ...
        e.fn.position = function (n) {
            ...
            this.each(function () {
                ...
                n.using && (l = function (e) {
                    ...
                    h.important = o(r(t), r(i)) > o(r(s), r(a))
                        ? "horizontal"
                        : "vertical",
                    n
                        .using
    ...
    e.widget("ui.accordion", {
        ...
        _destroy: function () {
            ...
            this
                .headers
                .removeClass(
                    "ui-accordion-header ui-accordion-header-active ui-state-default ui-corner-all " +
            ...
            e = this
                ...
                .next()
                .removeClass(
                    "ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content ui-acc" +
                    "ordion-content-active ui-state-disabled"
                )
                .css("display", "")
                .removeAttr("role")
        ...
        _refresh: function () {
            ...
            "fill" === s
                ...
                : "auto" === s && (t = 0, this.headers.next().each(function () {
        ...
        _eventHandler: function (t) {
            ...
            t.preventDefault(),
            a && !i.collapsible || this._trigger("beforeActivate", t, l) === !1 || (
                i.active = o
                    ? !1
                    : this.headers.index(n),
                this.active = a
                    ? e()
                    : n,
                this._toggle(l),
                s.removeClass("ui-accordion-header-active ui-state-active"),
                i.icons && s.children(".ui-accordion-header-icon").removeClass(
        ...
        _animate: function (e, t, i) {
            ...
            t.length
                ? e.length
                    ? (s = e.show().outerHeight(), t.animate(this.hideProps, {
                        duration: a,
                        easing: n,
                        step: function (e, t) {
                            t.now = Math.round(e)
    ...
    e.widget("ui.menu", {
            ...
            this._on({
                    ...
                    !this.mouseHandled && i
                        ...
                        .length && (
                            ...
                            i.has(".ui-menu").length
                                ? this.expand(t)
                                : !this.element.is(":focus") && e(this.document[0].activeElement).closest(
                                    ".ui-menu"
                                ).length && (
                ...
                blur: function (t) {
                    this._delay(function () {
                        e.contains(this.element[0], this.document[0].activeElement) || this.collapseAll(
                            t
                        )
                    })
                },
        ...
        _keydown: function (t) {
            ...
            switch (t.keyCode) {
                ...
                case e.ui.keyCode.RIGHT:
                    this.active && !this
                        .active
                        .is(".ui-state-disabled") && this.expand(t);
                    break;
                ...
                default:
                    ...
                    i = a && -1 !== i.index(this.active.next())
                        ? this
                            .active
        ...
        focus: function (e, t) {
            ...
            s = this
                ...
                .removeClass("ui-state-active"),
            this.options.role && this
                .element
                .attr("aria-activedescendant", s.attr("id")),
            this
                .active
                .parent()
            ...
            return this.active
                ? (this.isLastItem() || (
                    this._hasScroll()
                        ...
                        : this.focus(t, this.activeMenu.find(this.options.items)[
                            this.active
                                ? "last"
                                : "first"
                        ]())
        ...
        _move: function (e, t) {
            return this
                ...
                .is(":visible")
                    ? this
                        .menu
                        .isFirstItem() && /^previous/
                        .test(e) || this
                        .menu
                        .isLastItem() && /^next/.test(e)
    ...
    var c,
        ...
        f = "ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-i" +
                "con-primary ui-button-text-icon-secondary ui-button-text-only",
        m = function () {
            var t = e(this);
            setTimeout(function () {
                t
    ...
    e.widget("ui.button", {
        ...
        _create: function () {
            ...
            s && this
                .element
                .bind("change" + this.eventNamespace, function () {
                    t.refresh()
                }),
            "checkbox" === this.type
                ? this
        ...
        _resetButton: function () {
            ...
            s.primary || s.secondary
                ? (this.options.text && a.push("ui-button-text-icon" + (
                    n
                        ? "s"
                        : s.primary
                            ? "-primary"
    ...
    e.widget("ui.buttonset", {
        version: "1.11.2",
        options: {
            items: "button, input[type=button], input[type=submit], input[type=reset], input[type=" +
                    "checkbox], input[type=radio], a, :data(ui-button)"
        },
        _create: function () {
            this
                .element
    ...
    e.extend(n.prototype, {
        ...
        _newInst: function (t, i) {
            ...
            return {
                ...
                dpDiv: i
                    ? a(e(
                        "<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-conten" +
                        "t ui-helper-clearfix ui-corner-all'></div>"
                    ))
                    : this.dpDiv
            }
        },
            ...
            ("button" === s || "both" === s) && (
                ...
                i.trigger = e(
                    this._get(i, "buttonImageOnly")
                        ...
                        : e("<button type='button'></button>").addClass(this._triggerClass).html(
                            a
                                ? e("<img/>").attr({src: a, alt: n, title: n})
                                : n
                        )
                ),
                t[
                ...
                i.trigger.click(function () {
                    return e.datepicker._datepickerShowing && e.datepicker._lastInput === t[0]
                        ? e
                            .datepicker
                            ._hideDatepicker()
        ...
        _autoSize: function (e) {
            if (this._get(e, "autoSize") && !e.inline) {
                ...
                o.match(/[DM]/) && (t = function (e) {
                    ...
                    return s
                }, a.setMonth(t(this._get(
                    e,
                    o.match(/MM/)
                        ? "monthNames"
                        : "monthNamesShort"
                ))), a.setDate(t(this._get(
                    e,
                    o.match(/DD/)
                        ? "dayNames"
                        : "dayNamesShort"
                ...
                e
                    .input
                    .attr("size", this._formatDate(e, a).length)
            }
        },
        ...
        _dialogDatepicker: function (t, i, s, n, a) {
            ...
            return c || (
                ...
                o = "dp" + this.uuid,
                this._dialogInput = e(
                    "<input type='text' id='" + o + "' style='position: absolute; top: -100px; widt" +
                    "h: 0px;'/>"
                ),
            ...
            if (a._keyEvent = !0, e.datepicker._datepickerShowing) 
                switch (t.keyCode) {
                    ...
                    case 13:
                        ...
                        n[0] && e
                            .datepicker
                            ._selectDay(t.target, a.selectedMonth, a.selectedYear, n[0]),
                        i = e
                            .datepicker
                            ._get(a, "onSelect"),
                        i
                            ? (s = e.datepicker._formatDate(a), i.apply(
                                a.input
                                    ? a.input[0]
                                    : null,
                                [s, a]
        ...
        _showDatepicker: function (t) {
            if (
                ...
                i = e
                    .datepicker
                    ._getInst(t),
                e.datepicker._curInst && e.datepicker._curInst !== i && (
                ...
                a !== !1 && (
                    ...
                    i.dpDiv.css({
                        position: e.datepicker._inDialog && e.blockUI
                            ? "static"
                            : o
                                ? "fixed"
                                : "absolute",
        ...
        _updateDatepicker: function (t) {
            ...
            t === e.datepicker._curInst && e.datepicker._datepickerShowing && e
                .datepicker
                ._shouldFocusInput(t) && t
                .input
                .focus(),
            t.yearshtml && (i = t.yearshtml, setTimeout(function () {
                i === t.yearshtml && t.yearshtml && t
                    .dpDiv
        ...
        _checkExternalClick: function (t) {
            if (e.datepicker._curInst) {
                ...
                (
                    ...
                    ).length && e.datepicker._datepickerShowing && (!e.datepicker._inDialog || !e.blockUI) || i.hasClass(e.datepicker.markerClassName) && e.datepicker._curInst !== s
                ) && e
                    .datepicker
                    ._hideDatepicker()
            }
        ...
        _adjustDate: function (t, i, s) {
            var n = e(t),
                a = this._getInst(n[0]);
            this._isDisabledDatepicker(n[0]) || (this._adjustInstDate(a, i + (
                "M" === s
                    ? this._get(a, "showCurrentAtPos")
                    : 0
            ), s), this._updateDatepicker(a))
        },
        ...
        parseDate: function (t, i, s) {
            ...
            if (
                -1 === m
                    ...
                    : 100 > m && (
                        m += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (
                            u >= m
                                ? 0
                                : -100
                        )
                ...
                .map(function () {
                    var t = {
                        ...
                        selectMonth: function () {
                            return e
                                .datepicker
                                ._selectMonthYear(s, this, "M"),
                            !1
                        },
                        selectYear: function () {
                            return e
                                .datepicker
                                ._selectMonthYear(s, this, "Y"),
                            !1
                        }
                    };
                    e(this).bind(
        ...
        _generateHTML: function (e) {
            ...
            if (0 > Z && (Z += 12, et--), $) 
                for (
                    t = this._daylightSavingAdjust(new Date($.getFullYear(), $.getMonth() - K[0] * K[1] + 1, $.getDate())),
                    t = X && X > t
                        ? X
                        : t; this._daylightSavingAdjust(new Date(et, Z, 1)) > t;
                ) 
                    Z--,
                    0 > Z && (Z = 11, et--);
        for (
                ...
                s = this._canAdjustMonth(e, -1, et, Z)
                    ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='cl" +
                            "ick' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (
                        Y
                            ? "e"
                            : "w"
                    ) + "'>" + i + "</span></a>"
                ...
                a = this._canAdjustMonth(e, 1, et, Z)
                    ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='cl" +
                            "ick' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (
                        Y
                            ? "w"
                            : "e"
                    ) + "'>" + n + "</span></a>"
                ...
                r = this._get(e, "gotoCurrent") && e.currentDay
                    ? G
                    : R,
                o = q
                ...
                h = e.inline
                    ? ""
                    : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-" +
                            "primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(
                        e,
                        "closeText"
                    ) + "</button>",
                l = B
                    ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (
                        ...
                        this._isInRange(e, r)
                            ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priorit" +
                                    "y-secondary ui-corner-all' data-handler='today' data-event='click'>" + o + "</" +
                            "button>"
                            : ""
                    ) + (
                        Y
                ...
                for (k = "", this.maxRows = 4, T = 0; K[1] > T; T++) {
                    ...
                    for (
                        M += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + S +
                                    "'>" + (
                            /all|left/.test(S) && 0 === w
                                ? Y
                                    ? a
                            ...
                            /all|right/.test(S) && 0 === w
                                ? Y
                                    ...
                                    : a
                                : ""
                        ) + this._generateMonthYearHeader(e, Z, et, X, $, w > 0 || T > 0, f, m) + "</di" +
                                    "v><table class='ui-datepicker-calendar'><thead><tr>",
                        C = d
                    ...
                    for (
                        ...
                        for (
                            M += "<tr>",
                            E = d
                                ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(H) + "</t" +
                                        "d>"
                                : "",
                            x = 0; 7 > x; x++
                        ) 
                            ...
                            E += "<td class='" + (
                                ...
                                H.getTime() === D.getTime() && Z === e.selectedMonth && e._keyEvent || b.getTime() === H.getTime() && b.getTime() === D.getTime()
                                    ? " " + this._dayOverClass
                                    : ""
                            ) + (
                                W
        ...
        _generateMonthYearHeader: function (e, t, i, s, n, a, o, r) {
            ...
            if (a || !g) 
                ...
                for (
                    h = s && s.getFullYear() === i,
                    l = n && n.getFullYear() === i,
                    _ += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='cha" +
                            "nge'>",
                    u = 0;
                    12 > u;
                    u++
                ) 
                    (!h || u >= s.getMonth()) && (!l || n.getMonth() >= u) && (
                        _ += "<option value='" + u + "'" + (
                            u === t
                                ? " selected='selected'"
                                : ""
                ...
                if (e.yearshtml = "", a || !v) 
                    ...
                    for (
                        ...
                        f = s
                            ...
                            : f,
                        m = n
                            ? Math.min(m, n.getFullYear())
                            : m,
                        e.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='chang" +
                                "e'>"; m >= f; f++
                    ) 
                        e.yearshtml += "<option value='" + f + "'" + (
                            f === i
                                ? " selected='selected'"
                                : ""
                        ) + ">" + f + "</option>";
        ...
        _adjustInstDate: function (e, t, i) {
            var s = e.drawYear + (
                ...
                a = Math.min(e.selectedDay, this._getDaysInMonth(s, n)) + (
                    "D" === i
                        ? t
                        : 0
                ),
        ...
        _notifyChange: function (e) {
            ...
            t && t.apply(
                e.input
                    ...
                    : null,
                [
                    e.selectedYear, e.selectedMonth + 1,
                    e
                ]
            )
        },
        ...
        _getDaysInMonth: function (e, t) {
            return 32 - this
                ._daylightSavingAdjust(new Date(e, t, 32))
                .getDate()
        },
        ...
        _canAdjustMonth: function (e, t, i, s) {
            var n = this._getNumberOfMonths(e),
                a = this._daylightSavingAdjust(new Date(i, s + (
                    0 > t
                        ? t
                        : n[0] * n[1]
                ), 1));
        ...
        _isInRange: function (e, t) {
            ...
            (!n || t.getTime() >= n.getTime()) && (!a || t.getTime() <= a.getTime()) && (
                !o || t.getFullYear() >= o
            ) && (!r || r >= t.getFullYear())
        },
    ...
    e.fn.datepicker = function (t) {
        ...
        0 === e("#" + e.datepicker._mainDivId).length && e("body").append(
            e.datepicker.dpDiv
        );
        var i = Array
            .prototype
        ...
        return "string" != typeof t || "isDisabled" !== t && "getDate" !== t && "widget" !== t
            ? "option" === t && 2 === arguments.length && "string" == typeof arguments[1]
                ? e
                    .datepicker["_" + t + "Datepicker"]
                    .apply(e.datepicker, [this[0]].concat(i))
                : this.each(function () {
                    "string" == typeof t
                        ? e
                            .datepicker["_" + t + "Datepicker"]
                            .apply(e.datepicker, [this].concat(i))
                        : e
                            .datepicker
    ...
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        _mouseCapture: function (t) {
            ...
            this.helper || i.disabled || e(t.target)
        ...
        _blurActiveElement: function (t) {
            ...
            if (this.handleElement.is(t.target)) 
                try {
                    i.activeElement && "body" !== i
                        .activeElement
                        .nodeName
                        .toLowerCase() && e(i.activeElement).blur()
                } catch (s) {}
            },
        ...
        _mouseStop: function (t) {
            ...
            "invalid" === this.options.revert && !s || "valid" === this.options.revert && s || this.options.revert === !0 || e.isFunction(
                this.options.revert
            ) && this
                .options
                .revert
        ...
        _createHelper: function (t) {
            ...
            n[0] === this.element[0] || /(fixed|absolute)/.test(n.css("position")) || n.css(
                "position",
                "absolute"
            ),
            n
        ...
        _getRelativeOffset: function () {
            ...
            return {
                ...
                left: e.left - (parseInt(this.helper.css("left"), 10) || 0) + (
                    t
                        ? 0
            ...
            n.containment
                ? "window" === n.containment
                    ...
                    : "document" === n.containment
                        ? (
                            this.containment = [
                                0, 0, e(a).width() - this.helperProportions.width - this.margins.left,
                        ...
                        : n.containment.constructor === Array
                            ...
                            : (
                                ...
                                i = e(n.containment),
                                s = i[0],
                                s && (t = /(scroll|auto)/.test(i.css("overflow")), this.containment = [
                ...
                e.each(s.sortables, function () {
                    ...
                    a._intersectsWith(a.containerCache) && (
                        ...
                        e.each(s.sortables, function () {
                            ...
                            this !== a && this._intersectsWith(this.containerCache) && e.contains(
                                a.element[0],
                                this.element[0]
                            ) && (n = !1),
                            n
    ...
    e
        ...
        .add("draggable", "scroll", {
            start: function (e, t, i) {
                ...
                i.scrollParentNotHidden[0] !== i.document[0] && "HTML" !== i
                    .scrollParentNotHidden[0]
                    .tagName && (i.overflowOffset = i.scrollParentNotHidden.offset())
            },
            drag: function (t, i, s) {
                var n = s.options,
                    a = !1,
                ...
                a !== !1 && e.ui.ddmanager && !n.dropBehaviour && e
                    .ui
                    .ddmanager
                    .prepareOffsets(s, t)
            }
            ...
            drag: function (t, i, s) {
                ...
                for (c = s.snapElements.length - 1; c >= 0; c--) 
                    ...
                    d = u + s
                        .snapElements[c]
                        .height,
                    h - m > v || g > l + m || u - m > b || y > d + m || !e.contains(
                        s.snapElements[c].item.ownerDocument,
                        s.snapElements[c].item
                    )
                        ? (
                            s.snapElements[c].snapping && s.options.snap.release && s.options.snap.release.call(s.element, t, e.extend(s._uiHash(), {
                                snapItem: s
                                    .snapElements[c]
                                    .item
                            })),
    ...
    e.widget("ui.resizable", e.ui.mouse, {
        ...
        _mouseStart: function (t) {
            ...
            this.aspectRatio = "number" == typeof a.aspectRatio
                ? a.aspectRatio
        ...
        _mouseStop: function (t) {
            ...
            return this._helper && (
                ...
                r = parseInt(u.element.css("left"), 10) + (
                    u.position.left - u.originalPosition.left
                ) || null,
                h = parseInt(u.element.css("top"), 10) + (
        ...
        _getPaddingPlusBorderDimensions: function (e) {
            for (
                ...
                i = [],
                s = [
                    e.css("borderTopWidth"), e.css("borderRightWidth"), e.css("borderBottomWidth"), e.css("borderLeftWidth")
                ],
        ...
        .add("resizable", "animate", {
            stop: function (t) {
                var i = e(this).resizable("instance"),
                    ...
                    u = parseInt(i.element.css("top"), 10) + (
    ...
    e
        ...
        .add("resizable", "containment", {
            ...
            resize: function (t) {
                ...
                i = Math.abs(o.sizeDiff.width + (
                    o._helper
                        ? o.offset.left - d.left
                        : o.offset.left - h.left
                )),
                s = Math.abs(o.sizeDiff.height + (
                    o._helper
                        ? o.offset.top - d.top
                        : o.offset.top - h.top
                )),
    ...
    e
        ...
        .add("resizable", "ghost", {
            ...
            resize: function () {
                ...
                t.ghost && t
                    .ghost
                    .css({position: "relative", height: t.size.height, width: t.size.width})
            },
            stop: function () {
                var t = e(this).resizable("instance");
                t.ghost && t.helper && t
                        ...
                        : /^(sw)$/.test(r)
                            ...
                            : (
                                ...
                                f - u > 0
                                    ...
                                    : (f = u - t.height, i.size.height = f, i.position.top = o.top + a.height - f),
                                p - l > 0
                                    ? (i.size.width = p, i.position.left = o.left - d)
                                    : (p = u - t.height, i.size.width = p, i.position.left = o.left + a.width - p)
                            )
            }
        }),
    e.ui.resizable,
    e.widget("ui.dialog", {
        ...
        _moveToTop: function (t, i) {
            ...
            return a >=+ this
                .uiDialog
                .css("z-index") && (this.uiDialog.css("z-index", a + 1), s = !0),
        ...
        _createTitlebar: function () {
            ...
            this._on(this.uiDialogTitlebar, {
                mousedown: function (t) {
                    e(t.target).closest(".ui-dialog-titlebar-close") || this
                        .uiDialog
                        .focus()
                }
            }),
            ...
            this
                .uiDialog
                .attr({"aria-labelledby": t.attr("id")})
        },
        _title: function (e) {
        ...
        _size: function () {
            ...
            "auto" === s.height
                ? this
                    .element
                    .css({minHeight: t, maxHeight: i, height: "auto"})
                : this
                    .element
                    .height(Math.max(0, s.height - e)),
            this
                .uiDialog
                .is(":data(ui-resizable)") && this
                .uiDialog
        ...
        _blockFrames: function () {
            this.iframeBlocks = this
                ...
                .map(function () {
                    ...
                    return e("<div>")
                        .css(
                            {position: "absolute", width: t.outerWidth(), height: t.outerHeight()}
                        )
                        .appendTo(t.parent())
                        .offset(t.offset())[0]
                })
    ...
    e.widget("ui.droppable", {
        ...
        _over: function (t) {
            var i = e.ui.ddmanager.current;
            i && (i.currentItem || i.element)[0] !== this.element[0] && this
                .accept
                .call(this.element[0], i.currentItem || i.element) && (
            ...
            return s && (s.currentItem || s.element)[0] !== this.element[0]
                ? (
                    this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
                        ...
                        return i.options.greedy && !i.options.disabled && i.options.scope === s.options.scope && i
                            .accept
                            .call(i.element[0], s.currentItem || s.element) && e
                            .ui
                            .intersect(s, e.extend(i, {
                                offset: i
                                    .element
                                    .offset()
    ...
    e.ui.intersect = function () {
        ...
        return function (t, i, s, n) {
            ...
            switch (s) {
                ...
                case "pointer":
                    return e(n.pageY, u, i.proportions().height) && e(
                        n.pageX,
                        l,
                        i.proportions().width
                    );
                case "touch":
                    return (o >= u && c >= o || h >= u && c >= h || u > o && h > c) && (
    ...
    e.ui.ddmanager = {
        ...
        drop: function (t, i) {
            ...
            return e.each(
                ...
                function () {
                    this.options && (
                        !this.options.disabled && this.visible && e.ui.intersect(t, this, this.options.tolerance, i) && (s = this._drop.call(this, i) || s),
            ...
            e.each(e.ui.ddmanager.droppables[t.options.scope] || [], function () {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var s,
                        ...
                        o = e
                            .ui
                            .intersect(t, this, this.options.tolerance, i),
                        r = !o && this.isover
                            ? "isout"
                            : o && !this.isover
                                ? "isover"
    ...
    function (e, t) {
        ...
        var a,
            o = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopCo" +
                    "lor color columnRuleColor outlineColor textDecorationColor textEmphasisColor",
            r = /^([\-+])=\s*(\d+\.?\d*)/,
            h = [
                {
                            ...
                            ? (
                                n instanceof l
                                    ...
                                    : f(u, function (t, s) {
                                        ...
                                        d[a] && 0 > e.inArray(null, d[a].slice(0, 3)) && (d[a][3] = 1, s.from && (
                                            d._rgba = s.from(d[a])
                                        ))
                                    }),
                                this
    ...
    e.effects.effect.bounce = function (t, i) {
        ...
        _ > 1 && b
            .splice
            .apply(b, [1, 0].concat(b.splice(_, f + 1))),
        o.dequeue()
    },
    ...
    e.effects.effect.size = function (t, i) {
        ...
        ("content" === m || "both" === m) && a.from.y !== a.to.y && (
    ...
    e.effects.effect.scale = function (t, i) {
        var s = e(this),
            ...
            a = e
                .effects
                .setMode(s, t.mode || "effect"),
            o = parseInt(t.percent, 10) || (
    ...
    e.effects.effect.pulsate = function (t, i) {
        ...
        p > 1 && c
            .splice
            .apply(c, [1, 0].concat(c.splice(p, l + 1))),
        n.dequeue()
    },
    e.effects.effect.shake = function (t, i) {
        ...
        for (e.effects.save(n, a), n.show(), e.effects.createWrapper(n), f[c] = (
            ...
            p
                ? "-="
                : "+="
        ) + 2 * h, n.animate(f, d, t.easing), s = 1; l > s; s++) 
            n
        ...
        y > 1 && v
            .splice
            .apply(v, [1, 0].concat(v.splice(y, u + 1))),
        n.dequeue()
    },
    ...
    e.widget("ui.selectmenu", {
        ...
        _drawButton: function () {
            ...
            this.button = e("<span>", {
                ...
                tabindex: i || this.options.disabled
                    ? -1
                    : 0,
                id: this.ids.button,
                role: "combobox",
            ...
            this.buttonText = e("<span>", {"class": "ui-selectmenu-text"}).appendTo(
                this.button
            ),
            ...
            this.menuInstance = this
                ...
                .menu({
                    ...
                    focus: function (e, i) {
                        ...
                        null != t.focusIndex && s.index !== t.focusIndex && (
        ...
        _selectFocusedItem: function (e) {
            var t = this
                .menuItems
                .eq(this.focusIndex);
            t.hasClass("ui-state-disabled") || this._select(
                t.data("ui-selectmenu-item"),
                e
            )
        },
        ...
        _setAria: function (e) {
            ...
            this
                .button
                .attr({"aria-labelledby": t, "aria-activedescendant": t}),
            this
                .menu
                .attr("aria-activedescendant", t)
        },
        _setOption: function (e, t) {
            "icons" === e && this
                .button
        ...
        _toggleAttr: function () {
            ...
            this
                .menuWrap
                .toggleClass("ui-selectmenu-open", this.isOpen),
            this
                .menu
    ...
    e.widget("ui.slider", e.ui.mouse, {
        ...
        _create: function () {
            ...
            this
                .element
                .addClass(
                    "ui-slider ui-slider-" + this.orientation + " ui-widget ui-widget-content ui-co" +
                    "rner-all"
                ),
            this._refresh(),
        ...
        _createHandles: function () {
            var t,
                ...
                a = "<span class='ui-slider-handle ui-state-default ui-corner-all' tabindex='0'></s" +
                        "pan>",
                o = [];
            for (
        ...
        _destroy: function () {
            ...
            this
                .element
                .removeClass(
                    "ui-slider ui-slider-horizontal ui-slider-vertical ui-widget ui-widget-content " +
                    "ui-corner-all"
                ),
            this._mouseDestroy()
        },
        ...
        _normValueFromMouse: function (e) {
            ...
            return "horizontal" === this.orientation
                ? (t = this.elementSize.width, i = e.x - this.elementOffset.left - (
                    this._clickOffset
                        ? this._clickOffset.left
                        : 0
                ))
                : (t = this.elementSize.height, i = e.y - this.elementOffset.top - (
                    this._clickOffset
        ...
        _slide: function (e, t, i) {
            ...
            this.options.values && this.options.values.length
                ...
                : i !== this.value() && (a = this._trigger("slide", e, {
                    handle: this.handles[t],
                    value: i
                }), a !== !1 && this.value(i))
        },
        ...
        values: function (t, i) {
            ...
            if (arguments.length > 1) 
                return this
                    .options
                    .values[t] = this._trimAlignValue(i),
                this._refreshValue(),
                this._change(null, t),
                void 0;
            if (!arguments.length) 
        ...
        _trimAlignValue: function (e) {
            ...
            var t = this.options.step > 0
                    ? this.options.step
                    : 1,
                i = (e - this._valueMin()) % t,
                s = e - i;
            return 2 * Math.abs(i) >= t && (
                s += i > 0
                    ? t
                    : -t
            ),
        ...
        _refreshValue: function () {
            ...
            this.options.values && this.options.values.length
                ...
                : (
                    ...
                    "min" === o && "horizontal" === this.orientation && this.range.stop(1, 1)[
                        l
                            ? "animate"
                            : "css"
                    ]({
                    ...
                    "max" === o && "horizontal" === this.orientation && this.range[
                        l
                            ? "animate"
                            : "css"
                    ]({
                    ...
                    "min" === o && "vertical" === this.orientation && this.range.stop(1, 1)[
                        l
                            ? "animate"
                            : "css"
                    ]({
                    ...
                    "max" === o && "vertical" === this.orientation && this.range[
                        l
                            ? "animate"
                            : "css"
                    ]({
        ...
        _handleEvents: {
            keydown: function (t) {
                ...
                switch (t.keyCode) {
                    ...
                    case e.ui.keyCode.DOWN:
                    case e.ui.keyCode.LEFT:
                        if (t.preventDefault(), !this._keySliding && (
                            this._keySliding = !0,
                ...
                switch (
                    a = this.options.step,
                    s = n = this.options.values && this.options.values.length
                        ? this.values(o)
                        : this.value(),
                    t.keyCode
                ) {
    ...
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        _isFloating: function (e) {
            return /left|right/.test(e.css("float")) || /inline|table-cell/.test(
                e.css("display")
            )
        },
        _create: function () {
                    ...
                    : (
                        ...
                        s
                            ? !this.options.handle || i || (
                                e(this.options.handle, s).find("*").addBack().each(function () {
                                    this === t.target && (n = !0)
                                }),
                                n
                            )
        ...
        _mouseStart: function (t, i, s) {
            ...
            e.ui.ddmanager && !o.dropBehaviour && e
                .ui
                .ddmanager
        ...
        _mouseDrag: function (t) {
            ...
            for (
                    ...
                    this.scrollParent[0] !== document && "HTML" !== this.scrollParent[0].tagName
                        ...
                        : (
                            t.pageY - e(document).scrollTop() < o.scrollSensitivity
                                ...
                                : e(window).height() - (t.pageY - e(document).scrollTop()) < o.scrollSensitivity && (
                ...
                if (
                    ...
                    a && s.instance === this.currentContainer && n !== this.currentItem[0] && this.placeholder[
                        1 === a
                            ? "next"
                            : "prev"
                    ]()[0] !== n && !e.contains(this.placeholder[0], n) && (
            ...
            if (t) {
                if (
                    ...
                    var s = this,
                        ...
                        o = {};
                    a && "x" !== a || (
                        o.left = n.left - this.offset.parent.left - this.margins.left + (
                    ...
                    a && "y" !== a || (
                        o.top = n.top - this.offset.parent.top - this.margins.top + (
                            this.offsetParent[0] === document.body
                                ? 0
                    ...
                    [
                        e.isFunction(this.options.items)
                            ? this
                                .options
                                .items
                                .call(this.element[0], t, {item: this.currentItem})
                            : e(this.options.items, this.element),
                        this
                    ]
                ],
                        ...
                        a && a !== this && !a.options.disabled && (d.push([
                            e.isFunction(a.options.items)
                                ? a
                                    .options
                                    .items
                                    .call(a.element[0], t, {item: this.currentItem})
            ...
            if (c) 
                if (1 === this.containers.length) 
                    ...
                    for (
                        ...
                        e.contains(this.containers[p].element[0], this.items[s].item[0]) && this
                            .items[s]
                            .item[0] !== this
                            .currentItem[0] && (
                                h = this.items[s].item.offset()[o],
                                l = !1,
                                t[d] - h > this.items[s][r] / 2 && (
                                    l = !0
                                ),
                                n > Math.abs(t[d] - h) && (
                                    n = Math.abs(t[d] - h),
        ...
        _createHelper: function (t) {
            ...
            (!s[0].style.height || i.forceHelperSize) && s.height(
        ...
        _getParentOffset: function () {
            ...
            (
                this.offsetParent[0] === document.body || this.offsetParent[0].tagName && "html" === this.offsetParent[0].tagName.toLowerCase() && e.ui.ie
            ) && (t = {
                top: 0,
                left: 0
            }), {
        ...
        _setContainment: function () {
            ...
            /^(document|window|parent)$/.test(n.containment) || (
                ...
                this.containment = [
                    i.left + (parseInt(e(t).css("borderLeftWidth"), 10) || 0) + (
        ...
        _convertPositionTo: function (t, i) {
            ...
            var s = "absolute" === t
                    ? 1
                    : -1,
                n = "absolute" !== this.cssPosition || this.scrollParent[0] !== document && e.contains(
                    this.scrollParent[0],
                    this.offsetParent[0]
                )
                    ? this.scrollParent
        ...
        _generatePosition: function (t) {
            ...
            return "relative" !== this.cssPosition || this.scrollParent[0] !== document && this.scrollParent[0] !== this.offsetParent[0] || (
    ...
    e.widget("ui.spinner", {
        ...
        _draw: function () {
            ...
            this
                .buttons
                .height() > Math.ceil(.5 * e.height()) && e.height() > 0 && e.height(
                    e.height()
                ),
            this.options.disabled && this.disable()
        },
        ...
        _buttonHtml: function () {
            return "<a class='ui-spinner-button ui-spinner-up ui-corner-tr'><span class='ui-icon " +
                    this.options.icons.up + "'>&#9650;</span></a><a class='ui-spinner-button ui-spi" +
                    "nner-down ui-corner-br'><span class='ui-icon " + this.options.icons.down + "'>" +
                    "&#9660;</span></a>"
        },
        _start: function (e) {
    ...
    e.widget("ui.tabs", {
        ...
        _initialActive: function () {
            ...
            t !== !1 && (t = this.tabs.index(this.tabs.eq(t)), -1 === t && (
                t = i
                    ? !1
                    : 0
            )),
        ...
        _setupHeightStyle: function (t) {
            ...
            "fill" === t
                ...
                : "auto" === t && (i = 0, this.panels.each(function () {
        ...
        _eventHandler: function (t) {
            ...
            t.preventDefault(),
            a.hasClass("ui-state-disabled") || a.hasClass("ui-tabs-loading") || this.running || o && !i.collapsible || this._trigger(
                "beforeActivate",
                t,
                u
            ) === !1 || (
        ...
        _destroy: function () {
            ...
            this
                ...
                .each(function () {
                    e.data(this, "ui-tabs-destroy")
                        ...
                        : e(this)
                            .removeClass(
                                "ui-state-default ui-state-active ui-state-disabled ui-corner-top ui-corner-bot" +
                                "tom ui-widget-content ui-tabs-active ui-tabs-panel"
                            )
                            .removeAttr("tabIndex")
            ...
            this
                .panels
                .show(),
            "content" !== this.options.heightStyle && this
                .panels
                .css("height", "")
        },
        enable: function (t) {
        ...
        _open: function (t, i, s) {
            ...
            if (s) {
                ...
                this
                    ...
                    .hide(),
                s.clone
                    ? (l = s.clone(), l.removeAttr("id").find("[id]").removeAttr("id"))
                    : l = s,
                e("<div>")
                    .html(l)
